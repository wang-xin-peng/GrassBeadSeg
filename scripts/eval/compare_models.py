...
使用方式：
    ...
    python scripts/eval/compare_models.py --mode baseline
...
MODELS = [
    ("v1-nano", PROJECT_ROOT / "models" / "our_method" / "yolo11n-seg-baseline_v1" / "weights" / "best.pt"),
    ("v1-small", PROJECT_ROOT / "models" / "our_method" / "yolo11s-seg-baseline_v1" / "weights" / "best.pt"),
    ("v2-nano", PROJECT_ROOT / "models" / "our_method" / "yolo11n-seg-v2" / "weights" / "best.pt"),
    ("v2-nano-best", PROJECT_ROOT / "models" / "our_method" / "yolo11n-seg-v2" / "weights" / "best.pt"),
    ("v2-nano-last", PROJECT_ROOT / "models" / "our_method" / "yolo11n-seg-v2" / "weights" / "last.pt"),
    ("v2-small", PROJECT_ROOT / "models" / "our_method" / "yolo11s-seg-v2" / "weights" / "best.pt"),
]
